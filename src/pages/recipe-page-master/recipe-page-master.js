...
.recipe-page-master_checkbox .checkmark:after {
  ...
  transform: rotate(45deg);
      ...
      <div className="p-3 py-4 grid grid-cols-12 gap-6 recipe-page-master items-start">
        ...
        <div className="col-span-12 grid grid-cols-12 gap-3 gap-y-6 md:col-span-3 md:order-1 md:shadow md:p-8 md:rounded-xl md:gap-6">
          <div className="flex space-x-1 col-span-12 md:col-span-12 items-center">
            ...
            <div>
              <div
                ...
                className="uppercase text-gray-500 font-semibold  leading-none text-xs md:text-sm"
              >
                Yields
              </div>
              <div className="text-xs text-primary md:text-base">12 servings</div>
            </div>
          </div>
          <div className="flex space-x-1 col-span-4 md:col-span-12 items-center">
            ...
            <div>
              ...
              <div className="text-xs font-medium md:text-base">45 minutes</div>
            </div>
          </div>
          <div className="flex space-x-1 col-span-4 md:col-span-12 items-center">
            <div className="text-lg ">
            ...
            <div>
              ...
              <div className="text-xs font-medium md:text-base">1 hour</div>
            </div>
          </div>
          <div className="flex space-x-1 col-span-4 md:col-span-12 items-center">
            <div className="text-lg ">
            ...
            <div>
              ...
              <div className="text-xs font-medium md:text-base">7,75 hours</div>
            </div>
          </div>
        </div>
